...
def main():
    ...
    parser.add_argument('--data_path', default='./data/data/data/',
    ...
    parser.add_argument('--logger_name', default='runs/runX_30k_post_rebuttal/',
    ...
    parser.add_argument('--cnn_type', default='vgg19',
                        ...
                        (e.g. vgg19, resnet152)""")
    parser.add_argument('--use_restval', default ='True', type = bool,
